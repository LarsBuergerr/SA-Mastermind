...
class MatrixSpec extends AnyWordSpec {
    "A Matrix" should {
        ...
        "have a cell method that returns the contents of the selected cell" in {
           ...
           matrix.cell(0, 0) should be(Stone("B"))
           matrix.cell(0, 1) should be(Stone("B"))
           matrix.cell(0, 2) should be(Stone("B"))
           matrix.cell(0, 3) should be(Stone("B"))
        
           matrix.cell(1, 0) should be(Stone("B"))
           matrix.cell(1, 1) should be(Stone("B"))
           matrix.cell(1, 2) should be(Stone("B"))
           matrix.cell(1, 3) should be(Stone("B"))
        }
